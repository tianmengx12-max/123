cli_args = dict(
    cfg_time_str='20260818_162942',
    config=None,
    config_dir='configs',
    custom_dataset_data_type='qa',
    custom_dataset_infer_method=None,
    custom_dataset_meta_path=None,
    custom_dataset_path='/mnt/tmx/qa_multiturn_merged23.jsonl',
    datasets=None,
    debug=False,
    dir_time_str='20260818_162942',
    dry_run=False,
        ...
        dict(
            ...
            infer_cfg=dict(
                inferencer=dict(
                    ...
                    output_json_filepath='./outputs/bimodal/20260818_162942',
                    pressure_time=15,
                    type=
            ...
            meta_path=None,
            path='/mnt/tmx/qa_multiturn_merged23.jsonl',
            reader_cfg=dict(
                input_columns=[
                    'question',
                    'max_out_len',
...
work_dir = './outputs/bimodal/20260818_162942'
