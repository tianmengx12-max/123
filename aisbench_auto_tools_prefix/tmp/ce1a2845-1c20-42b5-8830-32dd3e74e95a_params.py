cli_args = dict(
    cfg_time_str='20260820_161349',
    config=None,
    config_dir='configs',
    custom_dataset_data_type='qa',
    custom_dataset_infer_method=None,
    custom_dataset_meta_path=None,
    custom_dataset_path='/mnt/tmx/dataset/processed_bimodal_gsm8k.jsonl',
    datasets=None,
    debug=False,
    dir_time_str='20260820_161349',
    dry_run=False,
        ...
        dict(
            ...
            infer_cfg=dict(
                inferencer=dict(
                    ...
                    '/mnt/tmx/aisbench_auto_tools_prefix/outputs/bimodal/20260820_161349',
                    pressure_time=15,
                    type=
            ...
            meta_path=None,
            path='/mnt/tmx/dataset/processed_bimodal_gsm8k.jsonl',
            reader_cfg=dict(
                input_columns=[
                    'question',
                    'max_out_len',
...
work_dir = '/mnt/tmx/aisbench_auto_tools_prefix/outputs/bimodal/20260820_161349'
