cli_args = dict(
    ...
    custom_dataset_path=
    '/mnt/tmx/aisbench_dataset/scenario/scenario_fill_busy_fill_busy.jsonl',
    datasets=None,
    debug=False,
    dir_time_str='20260814_214057',
    dry_run=False,
...
datasets = [
    [
        dict(
            abbr='scenario_fill_busy_fill_busy',
            eval_cfg=dict(
                evaluator=dict(
                    type=
            ...
            infer_cfg=dict(
                inferencer=dict(
                    ...
                    output_json_filepath='./outputs/bimodal/20260814_214057',
                    pressure_time=15,
                    type=
...
work_dir = './outputs/bimodal/20260814_214057'
